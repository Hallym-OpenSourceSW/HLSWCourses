...
* **2학년 과정**
   * 1학기
      ...
      * 소프트웨어개론
      * 신호및시스템 (Python 오픈소스 라이브러리 활용) : OSS 7
...
* **3학년 과정**
   * 1학기
      * 인공지능 (오픈소스 SW Tensorflow 활용) : OSS 9
      * 컴퓨터그래픽스
      * 영상처리프로그래밍 (오픈소스 OpenCV 라이브러리 활용) : OSS 10
      * 운영체계 (오픈소스 Linux 기반 시스템 설계) : OSS 11
      * 프로그래밍어론
      * 윈도우 프로그래밍
      * 컴퓨터네트워크 (오픈 소스 TCP/IP 실습) : OSS 12
      * 정보보호론: 오픈소스형 공개 암호 코드  : OSS 13
      * 데이터마이닝 (파이썬 및 Scikit-learn 활용) : OSS 14
      * 데이터시각화 (오픈소스 R 라이브러리 활용) : OSS 15
      * 고급데이터베이스
      * 멀티미디어개론
      * 가상현실기초및실습
      * IoT 네트워크 (MQTT 오픈소스 활용) : OSS 16
      * 모바일센서공학
      * 소프트웨어특강I
      * 계산이론
...
* **4학년 과정**
   * 1학기
      ...
      * HCI
      * 딥러닝기초 : OSS 17
      * 빅데이터캡스톤 디자인 (빅데이터 오픈소스 SW 활용) : OSS 18
      * 콘텐츠 IT 캡스톤 디자인
      * 스마트IoT캡스톤디자인 (오픈소스 플랫폼인 아두이노 / 라즈베리파이 활용) : OSS 19
      * 시스템보안 : OSS 20
      * 통신네트워크 시스템 

      
* * *
2020년 1학기 **총 20개 교과목**에서 오픈소스 SW를 활용하거나 소개.
